import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as e,a as s}from"./app-JXXVuIpY.js";const d={},l=s(`<p><strong>重要提示</strong>: 熟悉每个编译过程有助于解决奇奇怪怪的问题</p><p><strong>比如:</strong> 可以查看预处理结果文件,最终要编译的代码是什么</p><p>gcc ***.c</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
1.预处理
