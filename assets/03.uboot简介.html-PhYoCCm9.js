import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as a,o as l,c as d,b as n,d as s,e as v,a as c}from"./app-MOeOou5h.js";const t={},r=n("h2",{id:"下载源码",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#下载源码","aria-hidden":"true"},"#"),s(" 下载源码")],-1),o={href:"https://docs.u-boot.org/en/latest/build/index.html",target:"_blank",rel:"noopener noreferrer"},u=c(`<p>已发布的版本可用作使用以下命名方案的标签：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>v&lt;year&gt;.&lt;month&gt;
