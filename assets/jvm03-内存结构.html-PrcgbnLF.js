import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as i,a as n}from"./app-JkC4P6Op.js";const d={},s=n(`<h2 id="堆" tabindex="-1"><a class="header-anchor" href="#堆" aria-hidden="true">#</a> 堆</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Java堆是JVM中最大的一块内存区域，用于存储对象实例和数组对象。
