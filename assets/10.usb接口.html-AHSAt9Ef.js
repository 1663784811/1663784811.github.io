import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,a as s}from"./app-c20o3SDW.js";const d={},l=s(`<p>USB 2.0：4根线（VCC、GND、D+、D-）。</p><p>USB 3.0/3.1：9根线（VCC、GND、D+、D-、TX+、TX-、RX+、RX-，以及屏蔽层）。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1. VCC (Power)：提供电源，通常为**+5V**。
