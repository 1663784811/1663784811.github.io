import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,a as d}from"./app-Fq1AZp76.js";const a={},s=d(`<h3 id="acid属性" tabindex="-1"><a class="header-anchor" href="#acid属性" aria-hidden="true">#</a> ACID属性</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Atomicity（原子性）：事务中的所有操作要么全部完成，要么全部不完成，不会出现部分完成的情况。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="方案" tabindex="-1"><a class="header-anchor" href="#方案" aria-hidden="true">#</a> 方案</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>2PC 	 保证强一致性，容易阻塞，有单点故障问题	小规模分布式系统

3PC	     减少阻塞和不确定性，但更复杂	要求较高一致性保障的分布式系统

TCC	     应用层实现，灵活，但实现复杂	强一致性要求的业务场景，如金融、电商

消息队列	 保证最终一致性，性能高	高并发、对实时性要求不高的场景

本地消息表	简单可靠，但需维护消息表	订单系统、支付系统等异步操作场景

Saga	适用于长事务，有补偿机制	微服务架构中的长事务、跨多个服务的事务场景

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10),l=[s];function r(v,c){return i(),n("div",null,l)}const m=e(a,[["render",r],["__file","01.分布式事务基础.html.vue"]]);export{m as default};
