import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,a as e}from"./app-35Zkv-qx.js";const i={},l=e(`<h3 id="安装nfs" tabindex="-1"><a class="header-anchor" href="#安装nfs" aria-hidden="true">#</a> 安装NFS</h3><p>NFS（Network File System，网络文件系统）是一种分布式文件系统协议，允许不同计算机通过局域网或广域网共享文件资源。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 服务端</span>
