import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as i,a as n}from"./app-ZNz1llaj.js";const d={},s=n(`<p>WebRTC（Web Real-Time Communication）是一种开源技术，允许浏览器和移动应用通过简单的API实现实时音视频通信和数据传输， 而无需安装插件或第三方软件。它由Google主导开发，现已成为W3C和IETF的标准。</p><h2 id="核心功能" tabindex="-1"><a class="header-anchor" href="#核心功能" aria-hidden="true">#</a> 核心功能</h2><h3 id="音视频通信" tabindex="-1"><a class="header-anchor" href="#音视频通信" aria-hidden="true">#</a> 音视频通信</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>支持高质量的实时音视频通话，包括降噪、回声消除、动态码率调整等。
