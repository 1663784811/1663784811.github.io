import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,a as t}from"./app-df0ehMoG.js";const p="/assets/img-04EN6fV8.png",e="/assets/img_1-xZ7M4EgJ.png",o={},c=t(`<h3 id="显示屏必须知道的值" tabindex="-1"><a class="header-anchor" href="#显示屏必须知道的值" aria-hidden="true">#</a> 显示屏必须知道的值</h3><p>宽度： 高度：</p><h3 id="丝滑移动位置" tabindex="-1"><a class="header-anchor" href="#丝滑移动位置" aria-hidden="true">#</a> 丝滑移动位置</h3><div class="language-C line-numbers-mode" data-ext="C"><pre class="language-C"><code>/*
丝滑移动位置
a 当前值
a_trg 期待值
b 速度
