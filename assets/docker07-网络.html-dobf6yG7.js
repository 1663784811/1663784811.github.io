import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as a,a as s}from"./app-Mmz5OFku.js";const i={},r=s(`<h2 id="桥接网络-bridge-network" tabindex="-1"><a class="header-anchor" href="#桥接网络-bridge-network" aria-hidden="true">#</a> 桥接网络（Bridge Network）：</h2><p>桥接网络是 Docker 默认使用的网络模式。每个容器都分配一个独立的 IP 地址， 并且可以通过<strong>容器名称</strong>进行通信。默认情况下， Docker 在主机上创建一个名为 docker0 的虚拟以太网桥接口，并将容器连接到这个网络上。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建一个桥接网络</span>
