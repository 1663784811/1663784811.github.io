...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+m+'" alt="img_12.png"></p><h3 id="第五步-修改代码并编译-无报错说明添加没问题" tabindex="-1"><a class="header-anchor" href="#第五步-修改代码并编译-无报错说明添加没问题" aria-hidden="true">#</a> 第五步: 修改代码并编译,无报错说明添加没问题</h3><p><img src="'+u+'" alt="img_13.png"></p><h3 id="第六步-初始化触摸屏和lcd驱动" tabindex="-1"><a class="header-anchor" href="#第六步-初始化触摸屏和lcd驱动" aria-hidden="true">#</a> 第六步： 初始化触摸屏和LCD驱动</h3>',34);function h(_,w){const d=l("ExternalLinkIcon");return a(),n("div",null,[p,e("p",null,[e("a",b,[i("GitHub下载地址"),r(d)])]),x])}const L=s(o,[["render",h],["__file","指南者移植LVGL.html.vue"]]);export{L as default};
