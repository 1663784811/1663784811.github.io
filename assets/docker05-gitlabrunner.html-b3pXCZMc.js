import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,a as e}from"./app-X9DILhSX.js";const i={},l=e(`<p>一、安装并配置必要的依赖项</p><p>a)在centos7的系统防火墙中打http和ssh访问</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#sudo  yum install -y curl policycoreutils-python openssh-server</span>
