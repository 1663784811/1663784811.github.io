import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as e,a as d}from"./app-fHh30XNa.js";const s={},l=d(`<h2 id="静态库与动态库的区别" tabindex="-1"><a class="header-anchor" href="#静态库与动态库的区别" aria-hidden="true">#</a> 静态库与动态库的区别</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>                静态库（.a）                         动态库（.so）
