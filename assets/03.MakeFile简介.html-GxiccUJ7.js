import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as i,a as n}from"./app-v0IrZdaY.js";const d={},s=n(`<h3 id="makefile简介" tabindex="-1"><a class="header-anchor" href="#makefile简介" aria-hidden="true">#</a> Makefile简介</h3><p>官网文档: https://www.gnu.org/software/make/manual/make.html</p><h3 id="安装make工具" tabindex="-1"><a class="header-anchor" href="#安装make工具" aria-hidden="true">#</a> 安装Make工具</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>=============== windows 
官网下载地址:
