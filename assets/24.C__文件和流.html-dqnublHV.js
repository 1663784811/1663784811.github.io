import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,a as t}from"./app-dBsuoIky.js";const e={},p=t(`<h3 id="文件操作" tabindex="-1"><a class="header-anchor" href="#文件操作" aria-hidden="true">#</a> 文件操作</h3><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code>C<span class="token operator">++</span> 提供了 <span class="token operator">&lt;</span>fstream<span class="token operator">&gt;</span> 头文件来支持文件操作，主要包含以下三个类：
