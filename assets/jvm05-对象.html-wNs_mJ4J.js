import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as i,a as s}from"./app-c20o3SDW.js";const d={},l=s(`<h3 id="对象布局" tabindex="-1"><a class="header-anchor" href="#对象布局" aria-hidden="true">#</a> 对象布局</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1.对象头： 占 16 字节（64位默认开启压缩类指针占12个字节）
        对象标记 (8 字节)
            哈希码
            GC标记
            GC次数
