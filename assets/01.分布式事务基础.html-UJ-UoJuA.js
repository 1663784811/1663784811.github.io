import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,a}from"./app-_8NupADL.js";const d={},s=a(`<h3 id="acid属性" tabindex="-1"><a class="header-anchor" href="#acid属性" aria-hidden="true">#</a> ACID属性</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Atomicity（原子性）：事务中的所有操作要么全部完成，要么全部不完成，不会出现部分完成的情况。
