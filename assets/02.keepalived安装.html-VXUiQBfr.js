import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as l,c as d,b as n,d as c,e as t,a as e}from"./app-wkWaJKuf.js";const r={},p=e(`<p>Keepalived 是一个用于提供高可用性和负载均衡解决方案的工具， 通常与 HAProxy 或 Nginx 等负载均衡器结合使用。 它通过 Virtual Router Redundancy Protocol (VRRP) 实现虚拟 IP 地址的故障转移， 使多个服务器节点能够共同维护一个虚拟 IP 地址，当主节点出现故障时，备份节点可以迅速接管服务。</p><h3 id="系统环境" tabindex="-1"><a class="header-anchor" href="#系统环境" aria-hidden="true">#</a> 系统环境</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>确认系统环境中是否已经安装了 gcc、make、openssl 和 openssl-devel 这些软件包，如果没有安装，可以通过以下命令进行安装
