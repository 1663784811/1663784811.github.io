import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as l,c as p,b as n,d as a,e,a as c}from"./app-IvGY8YdW.js";const o="/assets/img_1-hGjTvw_6.png",r="/assets/img-74ho7sF5.png",d="/assets/img_1-l2RH6mdC.png",u="/assets/img-kiD3UowL.png",v="/assets/20210415092849383-kWTeDuE2.png",m="/assets/02img-FAeCp9Wr.png",b="/assets/03img-XAblXosC.png",k="/assets/04img-T5CirFDD.png",h="/assets/05img-iaRyRfeX.png",g="/assets/06img-584HHq-5.png",f={},_={href:"https://ffmpeg.org/download.html",target:"_blank",rel:"noopener noreferrer"},x={href:"https://github.com/BtbN/FFmpeg-Builds/releases",target:"_blank",rel:"noopener noreferrer"},w=c('<p>注意amd64 和 arm64 <img src="'+o+'" alt="img_1.png"></p><p><img src="'+r+'" alt="img.png"></p><p><img src="'+d+'" alt="img_1.png"></p><p><img src="'+u+`" alt="img.png"></p><h3 id="基础知识" tabindex="-1"><a class="header-anchor" href="#基础知识" aria-hidden="true">#</a> 基础知识</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>码率（Bit Rate）:是指单位时间内传输或处理的比特数量
...
└─share
    ...
    └─man
        ├─man1
        └─man3
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="新建vs-c-空项目" tabindex="-1"><a class="header-anchor" href="#新建vs-c-空项目" aria-hidden="true">#</a> 新建VS C++ 空项目</h3><p><img src="`+m+'" alt="img.png"></p><h3 id="添加入口文件" tabindex="-1"><a class="header-anchor" href="#添加入口文件" aria-hidden="true">#</a> 添加入口文件</h3><p><img src="'+b+`" alt="img.png"></p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span><span class="token string">&lt;stdio.h&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="配置include目录" tabindex="-1"><a class="header-anchor" href="#配置include目录" aria-hidden="true">#</a> 配置include目录</h3><p><img src="`+k+'" alt="img.png"></p><h3 id="配置lib库目录" tabindex="-1"><a class="header-anchor" href="#配置lib库目录" aria-hidden="true">#</a> 配置lib库目录</h3><p><img src="'+h+'" alt="img.png"></p><h3 id="可能能会找不到dll文件" tabindex="-1"><a class="header-anchor" href="#可能能会找不到dll文件" aria-hidden="true">#</a> 可能能会找不到DLL文件</h3><p>在Path中添加dll目录 <img src="'+g+`" alt="img.png"></p><h3 id="验证" tabindex="-1"><a class="header-anchor" href="#验证" aria-hidden="true">#</a> 验证</h3><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span><span class="token string">&lt;stdio.h&gt;</span></span>
<span class="token keyword">extern</span> <span class="token string">&quot;C&quot;</span> <span class="token punctuation">{</span>
<span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;libavcodec\\avcodec.h&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,33);function y(D,q){const s=t("ExternalLinkIcon");return l(),p("div",null,[n("p",null,[n("a",_,[a("官网"),e(s)])]),n("p",null,[n("a",x,[a("下载编译包"),e(s)])]),w])}const L=i(f,[["render",y],["__file","01.ffmpeg.html.vue"]]);export{L as default};
