import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,a as d}from"./app-Fq1AZp76.js";const a={},s=d(`<h2 id="自定义view" tabindex="-1"><a class="header-anchor" href="#自定义view" aria-hidden="true">#</a> 自定义View</h2><p>View的绘制流程 ( 时序 )</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>构造函数
    属性初始化阶段
