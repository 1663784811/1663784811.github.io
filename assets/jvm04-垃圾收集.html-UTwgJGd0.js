import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as i,a as n}from"./app-QVpU4N0f.js";const d={},s=n(`<h2 id="gc" tabindex="-1"><a class="header-anchor" href="#gc" aria-hidden="true">#</a> GC</h2><p>串行收集器（Serial Garbage Collector）JDK 1.1</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>它是一个单线程的收集器，使用“标记-复制”算法。
