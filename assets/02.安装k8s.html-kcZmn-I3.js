import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as e,a}from"./app-8pttA6_c.js";const i={},l=a(`<h2 id="k8s-docker-对应版本" tabindex="-1"><a class="header-anchor" href="#k8s-docker-对应版本" aria-hidden="true">#</a> k8s docker 对应版本</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Kubernetes 版本	    Docker 版本
1.20        	        19.03, 19.03.12
1.21	                20.10, 20.10.7
1.22	                20.10, 20.10.7
1.23	                20.10, 20.10.7
