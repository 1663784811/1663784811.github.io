import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as n,o as s,c as i,b as e,d as r,e as d,a as c}from"./app-dOakPCSh.js";const l={},h={href:"https://github.com/rabbitmq/rabbitmq-auth-backend-http",target:"_blank",rel:"noopener noreferrer"},u=c(`<h3 id="第一步-开启插件" tabindex="-1"><a class="header-anchor" href="#第一步-开启插件" aria-hidden="true">#</a> 第一步：开启插件</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>rabbitmq-plugins <span class="token builtin class-name">enable</span> rabbitmq_auth_backend_http
