import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as i,a as s}from"./app-rxhDnrHf.js";const d={},a=s(`<h2 id="配置静态ip" tabindex="-1"><a class="header-anchor" href="#配置静态ip" aria-hidden="true">#</a> 配置静态IP</h2><p>编辑文件 /etc/sysconfig/network-scripts/ifcfg-ens33</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>TYPE=Ethernet
PROXY_METHOD=none
BROWSER_ONLY=no
