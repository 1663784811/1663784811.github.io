import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,a as t}from"./app-GC5NavQz.js";const e={},p=t(`<h3 id="计数信号量-std-counting-semaphore" tabindex="-1"><a class="header-anchor" href="#计数信号量-std-counting-semaphore" aria-hidden="true">#</a> 计数信号量 std::counting_semaphore</h3><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;iostream&gt;</span></span>
