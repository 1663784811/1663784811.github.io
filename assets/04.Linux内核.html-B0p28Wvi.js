import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as a,o as i,c as l,b as n,d,e as c,a as r}from"./app-K-eMSB5C.js";const t={},v={href:"https://www.kernel.org/",target:"_blank",rel:"noopener noreferrer"},o=r(`<h3 id="文件夹结构" tabindex="-1"><a class="header-anchor" href="#文件夹结构" aria-hidden="true">#</a> 文件夹结构</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1. arch/用途: 包含与特定架构（如 x86、ARM、MIPS 等）相关的代码。每个架构都有一个子目录，比如 x86/、arm/ 等。
