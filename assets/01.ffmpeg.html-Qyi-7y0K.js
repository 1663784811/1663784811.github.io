import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as s,a as e}from"./app-ZI3amp8f.js";const i="/assets/20210415092849383-kWTeDuE2.png",l="/assets/02img-FAeCp9Wr.png",d="/assets/03img-XAblXosC.png",c="/assets/04img-T5CirFDD.png",r="/assets/05img-iaRyRfeX.png",t="/assets/06img-584HHq-5.png",p={},o=e('<h3 id="模块" tabindex="-1"><a class="header-anchor" href="#模块" aria-hidden="true">#</a> 模块</h3><p>libavcodec : 编/解码 <br> libavfilter : 帧级操作（如添加滤镜）<br> libavformat : 文件 I/O 和 封装/解封装 <br> libavdevice : 设备视频文件的封装/解封装 <br> libavutil : 通用工具集合<br> libswresample : 音频重采样、格式处理、混音等<br> libpostproc : 预处理<br> libswscale : 色彩处理和缩放<br></p><h3 id="解码流程图" tabindex="-1"><a class="header-anchor" href="#解码流程图" aria-hidden="true">#</a> 解码流程图</h3><p><img src="'+i+`" alt="20210415092849383.png"></p><h3 id="学习环境搭建" tabindex="-1"><a class="header-anchor" href="#学习环境搭建" aria-hidden="true">#</a> 学习环境搭建</h3><h3 id="windows-ffmpeg编译" tabindex="-1"><a class="header-anchor" href="#windows-ffmpeg编译" aria-hidden="true">#</a> windows ffmpeg编译</h3><h3 id="下载源码和软件" tabindex="-1"><a class="header-anchor" href="#下载源码和软件" aria-hidden="true">#</a> 下载源码和软件</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 下载ffmpeg源码
