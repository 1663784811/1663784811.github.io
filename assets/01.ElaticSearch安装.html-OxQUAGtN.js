import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as t,c as l,b as n,d as s,e as c,a as o}from"./app-RaS7ap-Q.js";const d={},r=n("h3",{id:"第一步-下载elaticsearch",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#第一步-下载elaticsearch","aria-hidden":"true"},"#"),s(" 第一步: 下载ElaticSearch")],-1),m={href:"https://www.elastic.co/cn/downloads/elasticsearch",target:"_blank",rel:"noopener noreferrer"},p=o(`<h3 id="新的用户" tabindex="-1"><a class="header-anchor" href="#新的用户" aria-hidden="true">#</a> 新的用户</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 添加用户</span>
