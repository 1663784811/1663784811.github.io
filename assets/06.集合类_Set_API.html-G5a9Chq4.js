import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,a}from"./app-c20o3SDW.js";const d={},s=a(`<h3 id="实现类" tabindex="-1"><a class="header-anchor" href="#实现类" aria-hidden="true">#</a> 实现类</h3><h4 id="hashset" tabindex="-1"><a class="header-anchor" href="#hashset" aria-hidden="true">#</a> HashSet</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>无序（存取顺序不一致）
不可重复
线程不安全
允许存 null（只能存一个）
