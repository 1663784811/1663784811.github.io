import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as a,a as n}from"./app-GC5NavQz.js";const d="/assets/img-L-wWOA4b.png",s={},l=n(`<h3 id="使用合适的索引" tabindex="-1"><a class="header-anchor" href="#使用合适的索引" aria-hidden="true">#</a> 使用合适的索引</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>索引设计：根据查询模式和数据访问模式来设计索引。确保频繁查询的列上建立索引，避免在大表上使用全表扫描
