import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,a as r}from"./app-wkWaJKuf.js";const d={},a=r(`<p>字符串: String 、StringBuffer 、StringBuilder</p><h3 id="string" tabindex="-1"><a class="header-anchor" href="#string" aria-hidden="true">#</a> String</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>String 类是不可变的，一旦创建就不能被修改。每次对 String 进行操作（连接、拼接、修改等），都会创建一个新的 String 对象。
