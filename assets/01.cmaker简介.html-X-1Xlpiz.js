import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,b as a}from"./app-njWDhDvz.js";const s={},d=a(`<h3 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>CMake是一个跨平台的安装（编译）工具，可以用简单的语句来描述所有平台的安装(编译过程)。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),l=[d];function r(c,t){return i(),n("div",null,l)}const u=e(s,[["render",r],["__file","01.cmaker简介.html.vue"]]);export{u as default};
