import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as d,c as i,a}from"./app-JkC4P6Op.js";const n={},s=a(`<h2 id="离线安装docker系统" tabindex="-1"><a class="header-anchor" href="#离线安装docker系统" aria-hidden="true">#</a> 离线安装Docker系统</h2><h3 id="第一步-下载docker离线包" tabindex="-1"><a class="header-anchor" href="#第一步-下载docker离线包" aria-hidden="true">#</a> 第一步：下载docker离线包</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
...
4.安装成功后,会出现如下信息:
    ...
    docker info
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,12),r=[s];function t(l,c){return d(),i("div",null,r)}const v=e(n,[["render",t],["__file","docker01-包安装.html.vue"]]);export{v as default};
