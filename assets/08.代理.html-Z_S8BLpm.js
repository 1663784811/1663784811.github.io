import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as n,a as i}from"./app-8oEzPUXj.js";const d={},s=i(`<h3 id="静态代理" tabindex="-1"><a class="header-anchor" href="#静态代理" aria-hidden="true">#</a> 静态代理</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>静态代理是在编译时就已经确定代理类的结构，需要手动编写代理类。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),r=[s];function l(c,v){return a(),n("div",null,r)}const o=e(d,[["render",l],["__file","08.代理.html.vue"]]);export{o as default};
