import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as s,a as e}from"./app-925tRyXi.js";const i={},l=e(`<h2 id="在linux下编译android需要的-so文件" tabindex="-1"><a class="header-anchor" href="#在linux下编译android需要的-so文件" aria-hidden="true">#</a> 在linux下编译android需要的.so文件</h2><h3 id="安装ndk" tabindex="-1"><a class="header-anchor" href="#安装ndk" aria-hidden="true">#</a> 安装ndk</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 下载</span>
