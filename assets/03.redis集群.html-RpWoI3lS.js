import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as s,a}from"./app-eKbJYqPF.js";const i={},d=a(`<h2 id="_1-单机" tabindex="-1"><a class="header-anchor" href="#_1-单机" aria-hidden="true">#</a> 1.单机</h2><h2 id="_2-主从" tabindex="-1"><a class="header-anchor" href="#_2-主从" aria-hidden="true">#</a> 2.主从</h2><h3 id="架构" tabindex="-1"><a class="header-anchor" href="#架构" aria-hidden="true">#</a> 架构</h3><pre><code>7001 主
7002 从
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>前三个节点作为主节点（Master），后三个节点作为从节点（Slave）。</p><p>每个节点的配置文件 redis.conf 应包括以下内容：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
<span class="token builtin class-name">bind</span> <span class="token number">0.0</span>.0.0
protected-mode no
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>启动 Redis 实例 在每个节点上启动 Redis：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>redis-server /path/to/redis.conf
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,31),l=[d];function r(c,v){return e(),s("div",null,l)}const u=n(i,[["render",r],["__file","03.redis集群.html.vue"]]);export{u as default};
