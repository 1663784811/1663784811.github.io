import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,a}from"./app-o3AK3oAz.js";const d={},r=a(`<h2 id="网络模型osi" tabindex="-1"><a class="header-anchor" href="#网络模型osi" aria-hidden="true">#</a> 网络模型OSI</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>物理层（Physical Layer）：负责传输数据的物理媒介和比特流，例如电缆、光纤、无线信号等。
