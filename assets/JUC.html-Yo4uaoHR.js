import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as a,a as t}from"./app-jGYRCFrd.js";const r={},o=t(`<h1 id="juc-java-并发编程" tabindex="-1"><a class="header-anchor" href="#juc-java-并发编程" aria-hidden="true">#</a> JUC java 并发编程</h1><p>###################################### 两份内容 1.线程控制 2.锁</p><p>#####################################</p><h3 id="一、线程控制" tabindex="-1"><a class="header-anchor" href="#一、线程控制" aria-hidden="true">#</a> 一、线程控制</h3><pre><code>线程创建
    1.Thread 类
    2.Runable 接口
    3.Callable 接口
...
死锁排查
    ...
    jstack &lt;进程号&gt;
        Found 1 deadlock
</code></pre>`,7),c=[o];function u(d,l){return e(),a("div",null,c)}const h=n(r,[["render",u],["__file","JUC.html.vue"]]);export{h as default};
