import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as e,a}from"./app-SdsR07-H.js";const i={},l=a(`<h3 id="节点" tabindex="-1"><a class="header-anchor" href="#节点" aria-hidden="true">#</a> 节点</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#查看节点</span>
    kubectl get nodes
...
<span class="token comment">#添加 master 节点</span>
    第一步: master节点操作、生成token
        kubeadm token create
    第二步: <span class="token function">node</span> 节点操作 加入集群的
        <span class="token function">sudo</span> kubeadm <span class="token function">join</span> <span class="token operator">&lt;</span>master-ip<span class="token operator">&gt;</span>:<span class="token operator">&lt;</span>master-port<span class="token operator">&gt;</span> <span class="token parameter variable">--token</span> <span class="token operator">&lt;</span>token<span class="token operator">&gt;</span> --discovery-token-ca-cert-hash <span class="token operator">&lt;</span>ca-cert-hash<span class="token operator">&gt;</span>
        
<span class="token comment">#添加 worker 节点</span>
    第一步: master节点操作、生成token
        <span class="token comment"># 添加worker时，如果不知道令牌信息，可以通过下面的命令重新生成</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,19),t=[l];function r(o,d){return s(),e("div",null,t)}const v=n(i,[["render",r],["__file","03.基础知识和常用命令.html.vue"]]);export{v as default};
